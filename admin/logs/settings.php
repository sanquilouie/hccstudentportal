...
<html>
  ...
  <body class="hold-transition skin-yellow layout-top-nav" onload="myFunction()">
    ...
    <?php
        include('../../config.php');
        $query=mysqli_query($conn,"select * from settings order by sy")or die(mysqli_error());
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							...
							<?php
							 include('../../config.php');
								$query2=mysqli_query($conn,"select * from sy order by sy desc")or die(mysqli_error());
