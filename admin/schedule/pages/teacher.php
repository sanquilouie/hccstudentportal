...
<html>
  ...
  <body class="hold-transition skin-yellow layout-top-nav" onload="myFunction()">
        ...
        <div class="container">
	      ...
	      <div class="col-md-9">
              <div class="box box-warning">
               <form method="post" id="reg-form" action="teacher_save.php">
                <div class="box-body">
				<div class="row">
					<div class="col-md-12">
    ...
    <?php
        ...
        $query=mysqli_query($con,"select * from faculty left outer join designation on member.designation_id=designation.designation_id order by lastname")or die(mysqli_error());
    ...
    ?>
                ...
                <td>
                  ...
                  <a id="removeme" href="teacher_del.php?id=<?php echo $id;?>">
