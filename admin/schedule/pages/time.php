    ...
    <?php
        ...
        $query=mysqli_query($con,"select * from time order by days,time_start")or die(mysqli_error());
          ...
          while($row=mysqli_fetch_array($query)){
            ...
            $end=date("H:i",strtotime($row['time_end']));
            $day=$row['days'];
    ?>
                <tr>
                ...
                <td><?php echo $day;?></td>               
                <td>
                <a id="click" href="time.php?id=<?php echo $id;?>&start=<?php echo $start;?>&end=<?php echo $end;?>&day=<?php echo $day;?>">
...
<?php }?>           
        ...
        <div class="box-body" style="" id="displayform">
              ...
              <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $_REQUEST['id'];?>" placeholder="Time ID" readonly>
						  <div class="form-group">
              <div class="col-md-12">
						  <h4>Update Time Schedule</h4>
						  <div class="form-group">
							<label for="date">Start Time</label><br>
								<input type="time" class="form-control" name="start" placeholder="Start Time" value="<?php echo $_REQUEST['start'];?>" required>
								
						  </div><!-- /.form group -->
						  <div class="form-group">
							<label for="date">End Time</label><br>
								<input type="time" class="form-control" name="end" placeholder="End Time" value="<?php echo $_REQUEST['end'];?>" required>
								
						  </div><!-- /.form group -->
						  <div class="form-group">
							<label for="date">Day/s</label><br>
								<select class="form-control select2" name="day" required>
                <option selected value="<?php echo $_REQUEST['day'];?>"><?php echo $_REQUEST['day'];?></option>
									<option value="mwf">MWF Class</option>
									<option value="tth">TTH Class</option>
									<option value="fst">Exam Sched</option>
								</select>
